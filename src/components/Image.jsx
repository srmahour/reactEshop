export default function Image({loading = false, error = false, url='https://placehold.co/400', alt='image', height='h-[200px]'}){
  ...
  const onImageError = (e) => {
    ...
    return (
        <img
            src={url}
            alt={alt}
            className={`${height} w-full rounded-t-md object-cover`}
